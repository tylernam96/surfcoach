/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/next/dist/build/webpack/loaders/css-loader/src/index.js??ruleSet[1].rules[13].oneOf[2].use[1]!./node_modules/next/dist/build/webpack/loaders/next-font-loader/index.js??ruleSet[1].rules[13].oneOf[2].use[2]!./node_modules/next/font/google/target.css?{"path":"app/layout.tsx","import":"Instrument_Serif","arguments":[{"weight":["400"],"style":["normal","italic"],"subsets":["latin"],"variable":"--font-serif"}],"variableName":"instrumentSerif"} ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/* latin-ext */
@font-face {
  font-family: '__Instrument_Serif_1f5468';
  font-style: italic;
  font-weight: 400;
  font-display: swap;
...
@font-face {
  ...
  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
}@font-face {font-family: '__Instrument_Serif_Fallback_1f5468';src: local("Times New Roman");ascent-override: 117.94%;descent-override: 36.93%;line-gap-override: 0.00%;size-adjust: 83.94%
}.__className_1f5468 {font-family: '__Instrument_Serif_1f5468', '__Instrument_Serif_Fallback_1f5468';font-weight: 400
}.__variable_1f5468 {--font-serif: '__Instrument_Serif_1f5468', '__Instrument_Serif_Fallback_1f5468'
}

/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/next/dist/build/webpack/loaders/css-loader/src/index.js??ruleSet[1].rules[13].oneOf[2].use[1]!./node_modules/next/dist/build/webpack/loaders/next-font-loader/index.js??ruleSet[1].rules[13].oneOf[2].use[2]!./node_modules/next/font/google/target.css?{"path":"app/layout.tsx","import":"DM_Sans","arguments":[{"weight":["300","400","500"],"style":["normal","italic"],"subsets":["latin"],"variable":"--font-sans"}],"variableName":"dmSans"} ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/* latin-ext */
@font-face {
...
}.__variable_c3bde9 {--font-sans: '__DM_Sans_c3bde9', '__DM_Sans_Fallback_c3bde9'
}
...
@layer theme {
  :root, :host {
    ...
    --color-ocean-teal: #0e7490;
    --color-ocean-light: #38bdf8;
    --color-ocean-hover: #7dd3fc;
    --color-coral: #f97316;
  }
}
@layer base {
...
@layer utilities {
  ...
  .border-coral\/20 {
    ...
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-coral) 20%, transparent);
    }
  }
  .border-green-500\/20 {
  ...
  .border-ocean-light\/15 {
    border-color: color-mix(in srgb, #38bdf8 15%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-ocean-light) 15%, transparent);
    }
  }
  .border-ocean-light\/20 {
    border-color: color-mix(in srgb, #38bdf8 20%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-ocean-light) 20%, transparent);
    }
  }
  .border-ocean-light\/25 {
    border-color: color-mix(in srgb, #38bdf8 25%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-ocean-light) 25%, transparent);
    }
  }
  .border-ocean-light\/30 {
    border-color: color-mix(in srgb, #38bdf8 30%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-ocean-light) 30%, transparent);
    }
  }
  .border-ocean-light\/40 {
    border-color: color-mix(in srgb, #38bdf8 40%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-ocean-light) 40%, transparent);
    }
  }
  .border-ocean-light\/50 {
    border-color: color-mix(in srgb, #38bdf8 50%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-ocean-light) 50%, transparent);
    }
  }
  .border-ocean-light\/70 {
    border-color: color-mix(in srgb, #38bdf8 70%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      border-color: color-mix(in oklab, var(--color-ocean-light) 70%, transparent);
    }
  }
  .border-red-500\/15 {
  ...
  .bg-ocean-light\/8 {
    background-color: color-mix(in srgb, #38bdf8 8%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-light) 8%, transparent);
    }
  }
  .bg-ocean-light\/10 {
    background-color: color-mix(in srgb, #38bdf8 10%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-light) 10%, transparent);
    }
  }
  .bg-ocean-light\/12 {
    background-color: color-mix(in srgb, #38bdf8 12%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-light) 12%, transparent);
    }
  }
  .bg-ocean-light\/15 {
    background-color: color-mix(in srgb, #38bdf8 15%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-light) 15%, transparent);
    }
  }
  .bg-ocean-light\/20 {
    background-color: color-mix(in srgb, #38bdf8 20%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-light) 20%, transparent);
    }
  }
  .bg-ocean-light\/50 {
    background-color: color-mix(in srgb, #38bdf8 50%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-light) 50%, transparent);
    }
  }
  .bg-ocean-light\/\[0\.06\] {
    background-color: color-mix(in srgb, #38bdf8 6%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-light) 6%, transparent);
    }
  }
  .bg-ocean-teal\/5 {
    background-color: color-mix(in srgb, #0e7490 5%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-teal) 5%, transparent);
    }
  }
  .bg-ocean-teal\/8 {
    background-color: color-mix(in srgb, #0e7490 8%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-teal) 8%, transparent);
    }
  }
  .bg-ocean-teal\/10 {
    background-color: color-mix(in srgb, #0e7490 10%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-teal) 10%, transparent);
    }
  }
  .bg-ocean-teal\/15 {
    background-color: color-mix(in srgb, #0e7490 15%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-teal) 15%, transparent);
    }
  }
  .bg-ocean-teal\/20 {
    background-color: color-mix(in srgb, #0e7490 20%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-teal) 20%, transparent);
    }
  }
  .bg-ocean-teal\/30 {
    background-color: color-mix(in srgb, #0e7490 30%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-ocean-teal) 30%, transparent);
    }
  }
  .bg-red-500\/8 {
  ...
  .from-coral\/10 {
    --tw-gradient-from: color-mix(in srgb, #f97316 10%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      --tw-gradient-from: color-mix(in oklab, var(--color-coral) 10%, transparent);
    }
    --tw-gradient-stops: var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position));
  }
  .via-black\/20 {
  ...
  .text-ocean-light\/50 {
    color: color-mix(in srgb, #38bdf8 50%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      color: color-mix(in oklab, var(--color-ocean-light) 50%, transparent);
    }
  }
  .text-ocean-light\/80 {
    color: color-mix(in srgb, #38bdf8 80%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      color: color-mix(in oklab, var(--color-ocean-light) 80%, transparent);
    }
  }
  .text-red-400 {
  ...
  .accent-ocean-light {
    accent-color: var(--color-ocean-light);
  }
  .shadow-lg {
  ...
  .shadow-ocean-light\/20 {
    --tw-shadow-color: color-mix(in srgb, #38bdf8 20%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      --tw-shadow-color: color-mix(in oklab, color-mix(in oklab, var(--color-ocean-light) 20%, transparent) var(--tw-shadow-alpha), transparent);
    }
  }
  .invert {
  ...
  .hover\:bg-ocean-light\/25 {
    &:hover {
      @media (hover: hover) {
        background-color: color-mix(in srgb, #38bdf8 25%, transparent);
        @supports (color: color-mix(in lab, red, red)) {
          background-color: color-mix(in oklab, var(--color-ocean-light) 25%, transparent);
        }
      }
    }
  }
  .hover\:bg-ocean-teal\/10 {
    &:hover {
      @media (hover: hover) {
        background-color: color-mix(in srgb, #0e7490 10%, transparent);
        @supports (color: color-mix(in lab, red, red)) {
